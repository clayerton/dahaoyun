export default {
  ...
  'app.register.welcome': '欢迎注册大豪云',
  'register.username.placeholder': '请设置用户名',
  'register.password.placeholder': '请设置登录密码',
  'register.confirm.placeholder': '请再次输入登录密码',
  'register.phone.placeholder': '请输入手机号',
  'fotgotpwd.step1.title': '安全验证',
  'fotgotpwd.step2.title': '重置密码',
  'fotgotpwd.step1.submit': '下一步',
  'fotgotpwd.step2.submit': '重置',
  'fotgotpwd.submit': '确定重置',
  ...
  'validation.password.strength.msg': '请至少输入 4 个字符。请不要使用容易被猜到的密码。',
  ...
  'validation.username.strength': '长度为2-20',
};
