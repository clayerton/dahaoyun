export default {
  ...
  'app.register.welcome': 'Welcome to register Dahao Cloud',
  'register.phone.placeholder': 'Please enter phone number',
  'register.password.placeholder': 'Please set the login password',
  'register.confirm.placeholder': 'Please enter your login password again',
  'fotgotpwd.step1.title': 'Safety verification',
  'fotgotpwd.step2.title': 'Reset Password',
  'fotgotpwd.step1.submit': 'Next step',
  'fotgotpwd.step2.submit': 'Reset',
  'fotgotpwd.submit': 'Confirm reset',
